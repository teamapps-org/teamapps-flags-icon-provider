...
public class FlagsIconProvider implements SvgIconProvider<IconStyle> {

	public static final String LIBRARY_ID = "flags";
	...
	private String getSVG(String styleId, String iconName) {
		...
		InputStream inputStream = getClass().getResourceAsStream("/org/teamapps/icon/flags/" + iconName);
		if (inputStream == null) {
			return null;
		}
		try {
